module MotionActivatedLight {
  ...
  instance goalMonitor: MotionActivatedLight.GoalMonitor base id 0x5000 \
    queue size Default.queueSize \
    stack size Default.stackSize \
    priority 100

  instance light: MotionActivatedLight.Light base id 0x5200

  instance motionSensor: MotionActivatedLight.MotionSensor base id 0x5100
